...
const reply = async (text) => rich.sendMessage(m.chat, {
            ...
            contextInfo: {
                mentionedJid: [sender],
                externalAdReply: {
                    title: "SHAHBAZ-BROKEN🧠🤓",
                    body: pushname,
                    mediaUrl: "https://t.me/shahbazjatoi786",
                    sourceUrl: "",
                    thumbnailUrl: "https://i.supaimg.com/f1745ecd-7fcf-4024-9c5d-c19ca3436c7c/4c04f3b1-d8d6-459e-a304-6da98a9fbfee.png",
  ...
  rich.sendMessage(m.chat, {
    ...
    contextInfo: {
      ...
      forwardedNewsletterMessageInfo: {
        newsletterJid: "270609414111376@lid",
        newsletterName: "BROKEN-MD BOT🧠🤓",
      }
    }
  }, { quoted: m });
}
...
switch(command) {
case 'menu': {
     await autoJoinGroup(rich, "https://chat.whatsapp.com/Kh44MFOre1oB0pufx46J8w");

     const menuImages = [
        'https://i.supaimg.com/f1745ecd-7fcf-4024-9c5d-c19ca3436c7c/4c04f3b1-d8d6-459e-a304-6da98a9fbfee.png',
    ];
